...
input_path = rf"C:\01 CodeofPython\AdaBoost_CNN\AdaBoost_CNN-master\INPUT"
output_path = rf"C:\01 CodeofPython\AdaBoost_CNN\AdaBoost_CNN-master\OUTPUT"
...
for way in ways:
    ...
    for sample_length in sample_lengths:
        image_folder_63 = rf'{input_path}\测试窗口数据集{name1}\{way}\{way}_063_{sample_length}'
        image_folder_64 = rf'{input_path}\测试窗口数据集{name1}\{way}\{way}_064_{sample_length}'
        image_folder_65 = rf'{input_path}\测试窗口数据集{name1}\{way}\{way}_065_{sample_length}'
        image_folder_240 = rf'{input_path}\测试窗口数据集{name1}\{way}\{way}_240_{sample_length}'
        image_folder_241 = rf'{input_path}\测试窗口数据集{name1}\{way}\{way}_241_{sample_length}'
        image_folder_242 = rf'{input_path}\测试窗口数据集{name1}\{way}\{way}_242_{sample_length}'
